...
-   Both qPCR and dPCR specific worksheets are present, it is suggested to hide worksheets of a platform you are not submitting results for
...
-   Flowchart to assist with completing the technical replicate qualifier columns in the qPCR_QC_Data and qPCR_Sample_Data worksheets
    ...
    -   Source with additional details is the Ontario reference document, [Protocol for Evaluations of RT-qPCR Performance Characteristics](https://files.ontario.ca/mecp-protocol-for-analyzing-wastewater-samples-en-2022-03-23.pdf)
